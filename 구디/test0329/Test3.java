...
class Buyer {
	...
	void buy(Food b) {
		...
		} else if (b instanceof Apple){
			System.out.println(b + "를(을) " + b.price + "가격에 구입");
			System.out.println("");
		} else if (b instanceof Peach){
			System.out.println(b + "를(을) " + b.price + "가격에 구입");
			System.out.println("");
		} else if (b instanceof Cock){
			System.out.println(b + "를(을) " + b.price + "가격에 구입");
			System.out.println("");
		} else if (b instanceof Sidar){
			System.out.println(b + "를(을) " + b.price + "가격에 구입");
			System.out.println("");
		} else if (b instanceof Biscuit){
			System.out.println(b + "를(을) " + b.price + "가격에 구입");
			System.out.println("");
		} else if (b instanceof Cookie){
			System.out.println(b + "를(을) " + b.price + "가격에 구입");
			System.out.println("");
		}
	}
	void summary() {
		...
		System.out.printf("구매 제품 전체 가격 : %,d\n", totPrice);
		System.out.printf("구매 제품 전체 포인트 : %,d\n", totPoint);
		System.out.print("총 구매 목록 : ");
		for (int i = 0; i < cnt; i++) {
